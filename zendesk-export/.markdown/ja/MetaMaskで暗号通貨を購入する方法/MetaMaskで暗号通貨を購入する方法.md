...
MetaMask自体に関する問題（地域や通貨の選択、または購入プロセスの問題など）については、サポートページの「Start a Conversation」（会話を始める）ボタンから、[MetaMaskサポートに連絡してください](https://support.metamask.io/hc/en-us/articles/360058969391)。
