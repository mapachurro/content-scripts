#### *바이낸스와 함께 MetaMask를 사용하는 경우 해당 주제에 대한 [바이낸스의 자료를 숙지할 것을 강력히 권장합니다](https://docs.binance.org/smart-chain/wallet/metamask.html). 즉, 손실을 피하기 위해 **이해해야 하는 몇 가지 기술적인 세부 정보가 있습니다**.*
